...
"""Displays the name, status, and wifi ssid of each available network interface.

TODO: Figure out how to get the (correct) SSID.

Parameters:
    * shortnic.exclude: Comma-separated list of interface prefixes to exclude (defaults to "lo,virbr,docker,vboxnet,veth")
    * shortnic.states: Comma-separated list of states to show (prefix with "^" to invert - i.e. ^down -> show all devices that are not in state down)
"""
...
class Module(bumblebee.engine.Module):
    ...
    def _update_widgets(self, widgets):
        ...
        for intf in interfaces:
            ...
            widget.full_text("{} {}".format(intf, state))
